package org.gisobject.tutorial.restapi.gson.streaming;
...
import static org.gisobject.tutorial.restapi.gson.streaming.StreamingGsonJsonProcessor.STREAMING_GSON_JSON_PROCESSOR;
 ...
 */
public class StreamingGsonJsonProcessorTest {
    @Test
    public void testObjectToJsonMapping() {
        List<Employee> employees;
        try (InputStream inputStream = EMPLOYEE_ARRAY.asInputStream()) {
            employees = STREAMING_GSON_JSON_PROCESSOR.readJson(inputStream);
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            STREAMING_GSON_JSON_PROCESSOR.writeJson(employees, outputStream);
